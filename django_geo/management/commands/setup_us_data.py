...
from django_geo.models import City, Continent, Country, \
    GeoCoordinate, State, Location, Zipcode
from django_geo.services import generate_current_us_cities_list, generate_current_us_states_list, generate_countries
